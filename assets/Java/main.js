var apiKey ="fb66696cb485b8db1cf4ab551869fcba"
...
var keyCount = 0;
// Search button has been clicked for city!
searchButton.click(function () {

  var cityUserInput = $("#locationSearch").val();  

  // Variable for current weather working 
  var urlCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + cityUserInput + "&Appid=" + apiKey ;
  // Variable for 5 day forecast working
  var urlFiveDay = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityUserInput + "&Appid=" + apiKey ;
  ...
  $.ajax({
      ...
      var fiveDayCard = $("#fiveDayForecast").addClass("card-body");
